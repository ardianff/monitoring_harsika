...
$nama_dokumen = 'Laporan Keuangan Harsika Tanggal $tgl_dari - $tgl_sampai';
...
// mencetak string 
$pdf->Cell(280,7,'LAPORAN KEUANGAN HARSIKA',0,1,'C');
...
$pdf->Cell(150,14,'KETERANGAN',1,0,'C');
...
while($d = mysqli_fetch_array($data)){
  ...
  $pdf->Cell(20,7,date('d-m-Y', strtotime($d['transaksi_tanggal'])),1,0,'C');
  $pdf->Cell(45,7, $d['kategori'] ,1,0,'C');
  $pdf->Cell(150,7,$d['transaksi_keterangan'],1,0,'C');
...
$pdf->Cell(195,7, "SALDO SEKARANG" ,1,0,'R');
